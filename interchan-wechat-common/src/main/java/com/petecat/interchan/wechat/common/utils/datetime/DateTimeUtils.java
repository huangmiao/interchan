package com.petecat.interchan.wechat.common.utils.datetime;
...
public class DateTimeUtils {
    ...
    public static int addMonthRetMonth(Date date, int yearAmount) {
        return addIntegerRet(date, Calendar.MONTH, yearAmount);
    }

    public static int addYearRetYear(Date date, int yearAmount) {
        return addIntegerRet(date, Calendar.YEAR, yearAmount);
    }

    public static int addDayRetDay(Date date, int yearAmount) {
        return addIntegerRet(date, Calendar.DATE, yearAmount);
    }

    private static int addIntegerRet(Date date, int dateType, int amount) {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(date);
        if (date != null) {
            calendar.add(dateType, amount);
