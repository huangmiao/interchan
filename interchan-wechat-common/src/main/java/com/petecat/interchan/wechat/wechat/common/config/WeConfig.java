package com.petecat.interchan.wechat.wechat.common.config;

/**
 * @Package: com.petecat.interchan.wechat.common.config
 * @Description 微信配置参数。请赋值进去
 * @author huang.miao
 * @date 2016年12月22日 下午2:11:29  
 * @since 1.0.0
