...
/**
 * @ClassName: WechatRefundDTO
 * @Description: TODO
 * @author: Shadow
 * @date: 2018/9/18 14:41
 */
@Data
public class WechatRefundDTO {

    private String appId; //公众id

    private String apiKey;//支付密匙

    private String mchId; //商户id

    private String nonce_str;//随机字符

    private String tradeNo;//订单号(微信订单号与商户订单号二选一)
    ...
    private String refundDesc; //退款原因 String(80)

    private String notifyUrl; //notify_url退款结果通知url
